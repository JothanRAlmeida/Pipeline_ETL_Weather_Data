# 🌤️ Pipeline ETL - Dados Climáticos de Montanha - ES

> Pipeline ETL automatizado para coleta, transformação e armazenamento de dados meteorológicos em tempo real da cidade de Montanha.
...
<img src='arquitetura_pipeline.png' alt='Arquitetura do Pipeline ETL'>
...
```bash
git clone https://github.com/JothanRAlmeida/Pipeline_ETL_Weather_Data.git
...
# Converte para datetime do fuso horário de Montanha
